...
/**
 * The Source of all Pipelines. Must be once and only once in every Pipeline.
 */
@MetaInfServices(Filter.class)
public class DocumentSource extends AnnotationBasedFilter implements Source, Serializable {
