...
public class WasabiContainerSQL {
	...
	public static String[] SQLQueryForMove(String containerUUID, String parentUUID) throws UnexpectedInternalProblemException {
		...
		try {
			...
			run.update(updateParentID, parentUUID, containerUUID);
