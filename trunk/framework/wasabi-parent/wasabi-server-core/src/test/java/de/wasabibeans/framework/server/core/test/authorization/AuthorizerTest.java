...
public class AuthorizerTest extends WasabiRemoteTest {
	...
	@Test
	public void simpleTest() throws WasabiException {
		...
		System.out.print("Setting INSERT with forbiddance as userRight at userRightsRoom... ");
		aclService().create(userRightsRoom, user, WasabiPermission.INSERT, false);
		System.out.println("done.");
		
		System.out.print("Setting WRITE with forbiddance as userRight at userRightsRoom... ");
		aclService().create(userRightsRoom, user, WasabiPermission.WRITE, false);
		System.out.println("done.");
